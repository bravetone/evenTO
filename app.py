...
def create_db():
    ...
    user_admin = User(name="Mohammad",family_name="Ghazi",username="admin",email="admin@admin.com",password=pass_c,role_name=role_admin)
...
@app.route('/dashboard')
def dashbaord():  # put application's code here
